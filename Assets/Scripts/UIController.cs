...
public class UIController : MonoBehaviour
{
    ...
    private void Awake()
    {
        karakterPaketiMovement = FindObjectOfType<KarakterPaketiMovement>();
        animasyon = FindObjectOfType<Animasyon>();
    ...
    public void TapToStartButtonClick()
    {
        ...
        animasyon.BaslangicAnimasyonAyari();
        karakterPaketiMovement.kosuDurumu = true;
    ...
    public void NextLevelButtonClick()
    {
        ...
        GameObject[] objeler = GameObject.FindGameObjectsWithTag("Noktalar");
    ...
    {
        StartCoroutine(YenilmeGeciktir());
    }

    IEnumerator YenilmeGeciktir()
    {
